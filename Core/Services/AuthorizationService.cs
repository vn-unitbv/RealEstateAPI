...
namespace Core.Services
{
    public class AuthorizationService
    {
        ...
        public bool ValidateToken(string tokenString)
        {
            ...
            {
                Console.Error.WriteLine($"Invalid Token: {tokenString}");
                return false;
            }
        ...
        public string HashPassword(string password)
        {
            byte[] salt;
            byte[] subkey;
            using (var deriveBytes = new Rfc2898DeriveBytes(password, SaltSize, PBKDF2IterCount, _hashAlgorithmName))
            {
        ...
        public bool VerifyHashedPassword(string hashedPassword, string password)
        {
            ...
            using (var deriveBytes = new Rfc2898DeriveBytes(password, salt, PBKDF2IterCount, _hashAlgorithmName))
            {
